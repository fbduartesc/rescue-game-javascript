...
$ git clone https://github.com/fbduartesc/rescue-game-javascript.git
```
...
This project is under the [MIT license](https://github.com/fbduartesc/rescue-game-javascript/blob/master/LICENSE).
